...
\author{Diego Raúl Rivas Huanca \\ Grupo de laboratorio: B} \\
\date{\today}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{figuras/diagrama_puertos.png}
  \caption{Arquitectura del mapeo de puertos: el navegador entra por
  \texttt{localhost:15619} en la máquina Windows (que cumple el rol de
  "VM" del enunciado), y Docker Desktop redirige esa conexión hacia el
  puerto 80 dentro del contenedor de Nginx.}
  \label{fig:puertos}
\end{figure}
...
\url{https://github.com/DiegoRivas1/cloud-computing-containerizacion-nginx.git}
